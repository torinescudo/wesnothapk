...
public class WesnothActivity extends SDLActivity
{
	...
	static native int nativeGetPhoneActions();
	static native boolean nativeQueuePhoneAction(int action);

	@Override
	protected void onCreate(Bundle savedState) {
		super.onCreate(savedState);
		if (!mBrokenLibraries && mLayout != null && mSurface != null) {
			phoneControls = new PhoneControls(this, mLayout, mSurface);
		}
	}
	...
	protected void onResume() {
		super.onResume();
		if (phoneControls != null) phoneControls.resume();
	}

	@Override
	protected void onPause() {
		if (phoneControls != null) phoneControls.pause();
		super.onPause();
	}
